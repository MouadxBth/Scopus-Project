...
public interface SearchRequest {
    ...
    default ScopusSearchResult getSearchResult(HttpResponse<String> response) {
        ...
        final JsonObject wrapper = ScopusJavaProjectApplication.GSON.fromJson(response
                .body(), JsonObject.class);

        return ScopusJavaProjectApplication.GSON.fromJson(wrapper.get("search-results"), ScopusSearchResult.class);
    }
